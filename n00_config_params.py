...
sujet_list = ['CHEe', 'GOBc', 'MAZm', 'TREt', 'POTm',
              'VERj', 'DUCa', 'CARv', 'BOUt', 'FLAb']

#### FR_CV
# LAVs excluded, didnt follow protocol and nasal didnt works
sujet_list_FR_CV =  ['CHEe', 'GOBc', 'MAZm', 'TREt', 'POTm', 
                     'VERj', 'DUCa', 'CARv', 'BOUt', 'FLAb',
                     'BANc', 'KOFs', 'LEMl', 'MUGa',
...
freq_band_dict_FC = {'wb' : {'theta' : [4, 8], 'alpha' : [8,12], 'beta' : [12,40], 'gamma' : [50, 120]},
...
freq_band_dict_FC_lmm = {'lf' : {'theta' : [4,8], 'alpha' : [8,12], 'beta' : [10,40]},
                'hf' : {'l_gamma' : [50, 80], 'h_gamma' : [80, 120]},
                'wb' : {'theta' : [4,8], 'alpha' : [8,12], 'beta' : [10,40], 'gamma' : [50, 120]}  }
...
if PC_ID == 'LAPTOP-EI7OSP7K':
    ...
    if perso_repo_computation:
        ...
        path_main_workdir = '/home/jules/smb4k/CRNLDATA/crnldata/cmo/Projets/IntraEEG_Respi_Cardiaque/NBuonviso201810_ieeg_respi_jules_valentin/iEEG_Lyon_VJ'
    path_general = '/home/jules/smb4k/CRNLDATA/crnldata/cmo/Projets/IntraEEG_Respi_Cardiaque/NBuonviso201810_ieeg_respi_jules_valentin/iEEG_Lyon_VJ'
    path_memmap = '/home/jules/smb4k/CRNLDATA/crnldata/cmo/Projets/IntraEEG_Respi_Cardiaque/NBuonviso201810_ieeg_respi_jules_valentin/iEEG_Lyon_VJ/Mmap'
    n_core = 6
    ...
    if perso_repo_computation:
        ...
        path_main_workdir = '/home/valentin/smb4k/CRNLDATA/crnldata/cmo/Projets/IntraEEG_Respi_Cardiaque/NBuonviso201810_ieeg_respi_jules_valentin//iEEG_Lyon_VJ'
    path_general = '/home/valentin/smb4k/CRNLDATA/crnldata/cmo/Projets/IntraEEG_Respi_Cardiaque/NBuonviso201810_ieeg_respi_jules_valentin//iEEG_Lyon_VJ'
    path_memmap = '/home/valentin/smb4k/CRNLDATA/crnldata/cmo/Projets/IntraEEG_Respi_Cardiaque/NBuonviso201810_ieeg_respi_jules_valentin//iEEG_Lyon_VJ/Mmap'
    n_core = 6

elif PC_ID == 'nodeGPU':

    PC_working = 'nodeGPU'
    path_main_workdir = '/crnldata/cmo/Projets/IntraEEG_Respi_Cardiaque/NBuonviso201810_ieeg_respi_jules_valentin//iEEG_Lyon_VJ/Script_Python_iEEG_Lyon_git'
    path_general = '/crnldata/cmo/Projets/IntraEEG_Respi_Cardiaque/NBuonviso201810_ieeg_respi_jules_valentin//iEEG_Lyon_VJ'
...
#### JULES NYC
    ...
    PC_working = 'node13'
    path_main_workdir = '/mnt/data/julesgranget/iEEG_Lyon/Script_Python_iEEG_Lyon_git'
    path_general = '/mnt/data/julesgranget/iEEG_Lyon'
    path_memmap = '/mnt/data/julesgranget/iEEG_Lyon/memmap'
    n_core = 15
    
path_mntdata = '/mnt/data/julesgranget/iEEG_Lyon'
...
'VERj' : {'nasal': 'p14+', 'ventral' : 'p13+', 'ECG' : 'ECG'}, # OK
'DUCa' : {'nasal': 'p17+', 'ventral' : None, 'ECG' : 'PULS+'}, # attention pas de chan ECG
'CARv' : {'nasal': 'p7+', 'ventral' : 'p8+', 'ECG' : 'ECG'}, # OK
'BOUt' : {'nasal': 'p15+', 'ventral' : 'p14+', 'ECG' : 'PULS+'}, # attention pas de chan ECG
'FLAb' : {'nasal': 'p7+', 'ventral' : 'p8+', 'ECG' : 'PULS+'}, # attention pas de chan ECG
'LAVs' : {'nasal': 'p21+', 'ventral' : 'p19+', 'ECG' : 'PULS+'}, # attention pas de chan ECG
...
ROI_list_dfc = ['amygdala', 'hippocampus', 'insula post']
sujet_list_dfc_FR_CV = ['BANc', 'CHEe', 'GOBc', 'LEMl', 'MUGa', 'POTm', 'pat_03083_1527', 'pat_03105_1551', 'pat_03174_1634']
sujet_list_dfc_allcond = ['CHEe', 'GOBc', 'POTm']
nrespcycle_FC_FR_CV = 54
nrespcycle_FC_allcond = 64
stretch_point_FC = 80
...
n_surr_fc = 1000
ISPC_ncycles = {'theta' : 10, 'alpha' : 10, 'beta' : 20, 'gamma' : 30}
...
variability_resp_sel_diff = 0.075
