...
def get_pli_ispc_dfc_trial(sujet, cond, band_prep, band, freq, trial_i):
    ...
    xr_export = xr.DataArray(mat_stretch, coords=dict_xr.values(), dims=dict_xr.keys())
...
def get_pli_ispc_dfc(sujet, cond, band_prep, band, freq):
    ...
    for trial_i in range(n_trials):
        get_pli_ispc_dfc_trial(sujet, cond, band_prep, band, freq, trial_i)
